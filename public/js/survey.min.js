  ...
  var Survey = function (element) {
    ...
    $('form').submit(function(e) {
      ...
      var location = window.location
        ...
        , url = location.origin + "/s/response/" + token
        , submit = $('.btn-submit')
        , form = $(this);
      ...
      $.ajax({
        ...
        if (r.thank_url) {
          ...
          window.setTimeout(function() {
            ...
            form.hide();
            form.parent().append($.parseHTML("<div class='response-ty'><h1>Thanks You, You Answers Has Been Submitted</h1>\
              <p class='ty-msg'>" + r.thank_msg + "</p></div>"));            

            }, 1500);
          }
        })
      .fail(function(r) {
        swal("We couldn't submit your answers, please try to submit your answer again.")
        submit.find('.fa').remove();
        formSubmitted = false;
      })
    });
